...
@model({
  settings: {idInjection: false, postgresql: {schema: 'evoting', table: 'admin_users'}}
})
export class AdminUsers extends Entity {
  ...
  @property({
    ...
    postgresql: {columnName: 'external_id', dataType: 'character varying', dataLength: 4000, dataPrecision: null, dataScale: null, nullable: 'YES', generated: undefined},
  })
  externalId?: string;
