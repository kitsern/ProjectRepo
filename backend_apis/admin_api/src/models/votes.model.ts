...
@model({
  settings: {idInjection: false, postgresql: {schema: 'evoting', table: 'votes'}}
})
export class Votes extends Entity {
  ...
  @property({
    ...
    id: 1,
    postgresql: {columnName: 'vote_id', dataType: 'character varying', dataLength: 50, dataPrecision: null, dataScale: null, nullable: 'NO', generated: undefined},
  })
  voteId: string;
  ...
  @property({
    ...
    postgresql: {columnName: 'vin_id', dataType: 'character varying', dataLength: 100, dataPrecision: null, dataScale: null, nullable: 'YES', generated: undefined},
  })
  vinId?: string;
  ...
  @property({
    ...
    postgresql: {columnName: 'candidate_id', dataType: 'character varying', dataLength: 100, dataPrecision: null, dataScale: null, nullable: 'YES', generated: undefined},
  })
  candidateId?: string;
  ...
  constructor(data?: Partial<Votes>) {
    super(data);
  }
}

export interface VotesRelations {
  // describe navigational properties here
}

export type VotesWithRelations = Votes & VotesRelations;
